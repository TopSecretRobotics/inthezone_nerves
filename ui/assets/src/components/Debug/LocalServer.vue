...
import LocalServerEvents from './LocalServerEvents.graphql'
import ObserveLocalServerEvents from './ObserveLocalServerEvents.graphql'
...
if (window.localStorage && typeof window.localStorage.setItem === 'function') {
  const key = 'LocalServer.Preferences'
  ...
  apollo: {
    events () {
      return {
        ...
        subscribeToMore: {
          document: ObserveLocalServerEvents,
          variables: () => {
            return {
              exclude: this.exclusions
            }
