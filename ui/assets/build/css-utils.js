...
module.exports.purify = function(cb) {
  var css = glob.sync(path.join(__dirname, '../../priv/static/**/*.css'))
  var js = glob.sync(path.join(__dirname, '../../priv/static/**/*.js'))

  Promise.all(css.map(function (file) {
    return new Promise(function (resolve) {
      console.log('\n Purifying ' + path.relative(path.join(__dirname, '../../priv/static'), file).bold + '...')
