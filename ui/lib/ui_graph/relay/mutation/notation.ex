defmodule UiGraph.Relay.Mutation.Notation do

  @moduledoc """
  Macros used to define Mutation-related schema entities.

  See `UiGraph.Relay.Mutation` for examples of use.
  """
  ...
  @doc """
  Define a mutation with a single input and a client mutation ID. See the `UiGraph.Relay.Mutation` module documentation for more information.
  """
  ...
  defp field_body(field_ident) do
    ...
    quote do
      ...
      middleware UiGraph.Relay.Mutation

      private UiGraph.Relay, :mutation_field_identifier, unquote(field_ident)
    end
  end
  ...
  @private_field_identifier_path [UiGraph.Relay, :mutation_field_identifier]
  ...
  @doc """
  Defines the input type for your payload field. See the `UiGraph.Relay.Mutation` module documentation for an example.
  """
  ...
  @doc """
  Defines the output (payload) type for your payload field. See the `UiGraph.Relay.Mutation` module documentation for an example.
  """
