defmodule UiGraph.Relay.Connection.Notation do

  @moduledoc """
  Macros used to define Connection-related schema entities

  See `UiGraph.Relay.Connection` for more information.
  """
  ...
  @private_node_type_identifier_path [UiGraph.Relay, :connection_node]
  @private_base_identifier_path [UiGraph.Relay, :connection_base]
