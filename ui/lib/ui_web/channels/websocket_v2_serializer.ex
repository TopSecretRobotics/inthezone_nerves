defmodule UiWeb.WebSocketV2Serializer do
  @moduledoc false
  ...
  def fastlane!(%Broadcast{} = msg) do
    data = OJSON.encode_to_iodata!([nil, nil, msg.topic, msg.event, msg.payload])
  ...
  def encode!(%Reply{} = reply) do
    ...
    {:socket_push, :text, OJSON.encode_to_iodata!(data)}
  end
  ...
  def decode!(raw_message, _opts) do
    [join_ref, ref, topic, event, payload | _] = OJSON.decode!(raw_message)
