...
static ERL_NIF_TERM
serial_framing_protocol_nif_echo_1(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[])
{
    if (argc != 1) {
...
static ErlNifFunc serial_framing_protocol_nif_funcs[] = {
    {"echo", 1, serial_framing_protocol_nif_echo_1},       {"getsizeof", 0, serial_framing_protocol_nif_getsizeof_0},
    {"open", 0, serial_framing_protocol_nif_open_0},       {"init", 1, serial_framing_protocol_nif_init_1},
    {"connect", 1, serial_framing_protocol_nif_connect_1}, {"is_connected", 1, serial_framing_protocol_nif_is_connected_1},
    {"read", 2, serial_framing_protocol_nif_read_2},       {"write", 2, serial_framing_protocol_nif_write_2}};
