defmodule Vex.Local.Server.Socket.Events do

  @events Vex.Event
  @target Vex.Local.Server.Socket

  @frames_event "local.server.socket.frames"
  @status_event "local.server.socket.status"
