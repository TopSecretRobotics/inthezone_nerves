defmodule Vex.Robot.Server.Socket.Events do

  @events Vex.Event
  @target Vex.Robot.Server.Socket

  @frames_event "robot.server.socket.frames"
  @status_event "robot.server.socket.status"
