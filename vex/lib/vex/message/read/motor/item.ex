defmodule Vex.Message.Read.Motor.Item do
...
defimpl Vex.FrameEncoder, for: Vex.Message.Read.Motor.Item do
  def encode(%@for{ req_id: req_id, index: index }) do
    read_message = Vex.Message.Read.new(req_id, Vex.Message.Read.Motor, index)
