defmodule Vex.Message.Read.Smartmotor do
  ...
  def subtopic_to_type!(subtopic) do
    case subtopic do
      _ when subtopic in [@topic_smartmotor_subtopic_all, :all] -> Read.Smartmotor.All
      _ when subtopic in 0..255 -> Read.Smartmotor.Item
    end
  end
  ...
  def type_to_subtopic!(subtopic) when is_atom(subtopic) or is_integer(subtopic) do
    case subtopic do
      Read.Smartmotor.All -> @topic_smartmotor_subtopic_all
