defmodule Vex.Message.Subscribe.Motor.Item do
...
defimpl Vex.FrameEncoder, for: Vex.Message.Subscribe.Motor.Item do
  def encode(%@for{ req_id: req_id, index: index }) do
    subscribe_message = Vex.Message.Subscribe.new(req_id, Vex.Message.Subscribe.Motor, index)
