defmodule Vex.Message.Subscribe.Motor do
  ...
  def subtopic_to_type!(subtopic) do
    case subtopic do
      _ when subtopic in [@topic_motor_subtopic_all, :all] -> Subscribe.Motor.All
      _ when subtopic in 0..255 -> Subscribe.Motor.Item
    end
  end
  ...
  def type_to_subtopic!(subtopic) when is_atom(subtopic) or is_integer(subtopic) do
    case subtopic do
      Subscribe.Motor.All -> @topic_motor_subtopic_all
