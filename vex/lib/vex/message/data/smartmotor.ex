defmodule Vex.Message.Data.Smartmotor do
  ...
  def subtopic_to_type!(subtopic) when is_integer(subtopic) do
    case subtopic do
      @topic_smartmotor_subtopic_all -> Data.Smartmotor.All
      _ when subtopic in 0..255 -> Data.Smartmotor.Item
    end
  end
  ...
  def type_to_subtopic!(subtopic) when is_atom(subtopic) or is_integer(subtopic) do
    case subtopic do
      Data.Smartmotor.All -> @topic_smartmotor_subtopic_all
