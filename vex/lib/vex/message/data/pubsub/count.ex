defmodule Vex.Message.Data.Pubsub.Count do
...
defimpl Vex.FrameEncoder, for: Vex.Message.Data.Pubsub.Count do
  def encode(%@for{ req_id: req_id, flag: flag, ticks: ticks, value: value }) do
    data_message = Vex.Message.Data.new(req_id, Vex.Message.Data.Pubsub, @for, flag, ticks, << value >>)
